@include('admin.inc.header', ['pageTitle' => 'Add Listing'])
              ...
              <form action="{{ url('admin/listings') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" name="listings_number_of_beds" id="listings_number_of_beds" placeholder="Number of Beds" value="1" required>
                  </div>
                  <div class="col-md-3">
